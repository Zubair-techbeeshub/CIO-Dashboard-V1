...
-- Insert default users for American Logics
INSERT INTO users (
...
SELECT
    c.id,
    'admin@americanlogics.com',
    '$2b$12$svfro/4EmCuHEBlhkFwjVufTnzuKmKwhnBnC5ULhXGMJ1czKOBnu6', -- americanlogics321
    'Admin',
    'User',
    'admin',
    CURRENT_DATE,
...
-- Insert sample clients for demo
INSERT INTO clients (
    client_id, name, domain, industry, company_size, contact_email,
    license_start_date, license_end_date, max_users, subscription_plan,
    monthly_cost
...
-- Insert sample users for demo clients
INSERT INTO users (
    client_id, email, password_hash, first_name, last_name, role,
...
SELECT
    c.id,
    'admin@techcorp.com',
    '$2b$12$haCMeUv8yDB29X4L7YnLC.OA40fuzm2DQzCQOggrle8Q.RLa9Yuge', -- techcorp321
    'John',
    'Smith',
    'admin',
    'IT',
...
SELECT
    c.id,
    'admin@datasolutions.com',
    '$2b$12$5v7uR9jPlPcx9J3PeMDQ3u84lm35x1gP.pt85ttucteQUjQRQgE.y', -- datasolutions321
    'Sarah',
    'Johnson',
    'admin',
    'Analytics',
